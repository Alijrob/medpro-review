...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("gender", sa.String(1), nullable=False, server_default="'U'"),
    ...
    op.create_table(
        ...
        sa.Column("report_type", sa.String(20), nullable=False, server_default="'comprehensive'",
    ...
    op.create_table(
        ...
        sa.Column("provider_npi", sa.String(10), nullable=False),
        sa.Column("submitter_type", sa.String(20), nullable=False, server_default="'consumer'",
